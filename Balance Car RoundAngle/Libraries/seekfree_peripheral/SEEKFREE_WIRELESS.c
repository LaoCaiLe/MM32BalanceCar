...
void wireless_uart_callback()
{
	...
	// if(!getball_start_flag)
	// {
	// 	if(wireless_rx_buffer[wireless_rx_index] == 0x19) wireless_rx_index++;
	// 	if(wireless_rx_buffer[wireless_rx_index] == 0x99) wireless_rx_index++;
	// 	if(wireless_rx_buffer[wireless_rx_index] == 0x11) wireless_rx_index++;
	// 	if(wireless_rx_buffer[wireless_rx_index] == 0x23) 
	// 	{
	// 		wireless_rx_index=0;
